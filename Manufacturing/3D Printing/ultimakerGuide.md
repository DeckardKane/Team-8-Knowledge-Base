...
Hold your right click on the mouse you are using and drag around
For Mac OS users:
Hold CTRL+click and drag around
Zooming in and out
For Windows OS users:
Use the scroll function on your mouse
For Mac OS users:
Use the scroll function on your mouse
...
Travel
This setting will allow you to make the nozzle travel over the print instead of along the top of it. This will eliminate the potential of the nozzle knocking the print over. Currently it if off, but we have not had an issue with keeping it off so unless necessary there is no need to turn it on.
Cooling
...
Build Plate Adhesion
There are 4 different types of build plate adhesions.
Skirt
...
Taking the print off of the bed
